...
Add.prototype.createAssociations = function(key, records, cb) {
  ...
  if(this.collection._validator && this.collection._validator.childValidators && this.collection._validator.childValidators[key]){
    associatedCollection = _.extend(new associatedCollection.constructor(associatedCollection.waterline,associatedCollection.connections),associatedCollection);
