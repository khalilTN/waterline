...
Add.prototype.createAssociations = function(key, records, cb) {
  ...
  var clonedConnection = new associatedCollection.constructor(associatedCollection.waterline,associatedCollection.connections);
  clonedConnection = _.extend(clonedConnection, associatedCollection);
  clonedConnection._validator = (this.collection._validator)?this.collection._validator.childValidators[key]:clonedConnection._validator;
  associatedCollection = clonedConnection;
