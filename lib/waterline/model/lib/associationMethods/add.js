...
Add.prototype.createAssociations = function(key, records, cb) {
  ...
  var originalCollection = this.collection.waterline.collections[collectionName];
  var associatedCollection = _.extend(new originalCollection.constructor(originalCollection.waterline,originalCollection.connections), originalCollection);
  if(this.collection._validator && this.collection._validator.childValidators[key]){
