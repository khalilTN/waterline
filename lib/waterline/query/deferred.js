...
var Promise = require('bluebird'),
    ...
    mergeCriterias = require('../utils/criteriasMerger'),
...
Deferred.prototype.populate = function(keyName, criteria) {
  ...
  try {
    ...
    var defaultCriteria = this._context.waterline.collections[this._context.identity]._attributes[keyName].criteria;
    if(defaultCriteria){
      criteria = mergeCriterias(defaultCriteria, criteria);
    }
